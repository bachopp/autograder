...
CREATE TABLE course (courseid INT NOT NULL PRIMARY KEY AUTO_INCREMENT, course_name VARCHAR(255) NOT NULL, single_assignments INT,group_assignments INT,description VARCHAR(255),number_of_slipdays INT,is_slipdays BOOL,is_private_repositories BOOL,is_code_review BOOL);
...
CREATE TABLE group (groupid INT NOT NULL PRIMARY KEY, group_name VARCHAR(255));
CREATE TABLE student_group (userid INT NOT NULL, groupid INT NOT NULL, FOREIGN KEY (userid) REFERENCES student(userid), FOREIGN KEY (groupid) REFERENCES group(groupid), PRIMARY KEY (userid, groupid));
...
CREATE TABLE group_asmt (groupid INT NOT NULL, asmtid INT NOT NULL,FOREIGN KEY (groupid) REFERENCES group(groupid),FOREIGN KEY (asmtid) REFERENCES asmt(asmtid), PRIMARY KEY (groupid, asmtid));
...
CREATE TABLE repo (repoid INT NOT NULL PRIMARY KEY, name VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, group_name VARCHAR(255) NOT NULL, groupid INT NOT NULL,FOREIGN KEY (groupid) REFERENCES group(groupid));
